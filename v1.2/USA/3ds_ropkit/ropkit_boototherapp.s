...
@ Let user know were actually trying
CALLFUNC_NOSP GSP_WRITEHWREGS, GSPGPU_SERVHANDLEADR, HWREGS_ADDR, blue, 4
...
/*
.word POP_R0PC
.word (ROPKIT_TMPDATA+0x28)
.word ROP_LDR_R0FROMR0
.word 0x88808084
*/

ROPMACRO_CMPDATA (ROPKIT_TMPDATA+0x28), 0x07C00000, ROPBUFLOC(skip_new3ds_otherapp_memcpy)

@ If above cmp match, copy new3ds otherapp over old3ds otherapp
CALLFUNC_NOSP MEMCPY, ROPBUF+0x1000, ROPBUF+0x3000, 0x2000, 0
skip_new3ds_otherapp_memcpy:
