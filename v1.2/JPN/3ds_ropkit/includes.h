...
#define ROP_LDRR1R1_STRR1R0 0x004408d8
#define POP_R5R6PC 0x00121154
#define ROP_CMPR0R1_ALT0 0x00380ca8
...
#define CFGIPC_SecureInfoGetRegion 0x00190240
#define ROP_COND_THROWFATALERR 0x00105de4
#define GXLOW_CMD4 0x00113534
#define GSP_SHAREDMEM_SETUPFRAMEBUF 0x00230a9c
